...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            @if(Request::is('admin*'))
                ...
                <li  class="{{ Request::is('admin/post*') ? 'active' : '' }} {{ Request::is('admin/pending/post') ? 'active' : '' }} {{ Request::is('admin/favorite') ? 'active' : '' }}">
    ...
    <div class="legal">
        <div class="copyright">
            &copy; 2016 - <?php echo date("Y")?> <a href="http://www.prosayed.com/" target="_blank">ProSayed</a> - All Right Reserve.
        </div>
        <div class="version">
            <b>Version: </b> 1.0.5
        </div>
