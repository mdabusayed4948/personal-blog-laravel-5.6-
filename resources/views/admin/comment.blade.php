                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($comments as $key => $comment)
                                    <tr>
                                        <td>
                                           <div class="media">
                                               <div class="media-left">
                                                   <a href="#">
                                                       <img src="{{ Storage::disk('public')->url('profile/'.$comment->user->image) }}" alt="Profile Image" width="64" height="64">
                                                   </a>
                                               </div>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-danger waves-effect btn-sm" onclick="deleteComment({{ $comment->id }})">
