        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">TOTAL FAVORRITE</div>
                               ...
                               <tbody>
                                  @foreach($popular_posts as $key=>$post)
                                     <tr>
                                         ...
                                         <td>
                                             @if($post->status == true)
                                                 <a class="btn btn-sm btn-primary waves-effect " target="_blank" href="{{ route('post.details',$post->slug) }}"><i class="material-icons">visibility</i></a>
                                             @else
