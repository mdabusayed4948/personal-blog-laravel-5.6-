                                   ...
                                   @foreach($authors as $key => $author)
                                       <tr>
                                           ...
                                           <td class="text-center">
                                               ...
                                               <button class="btn btn-danger btn-sm waves-effect  waves-float" type="button" onclick="deleteAuthors({{ $author->id }})" data-toggle="tooltip" data-placement="top" title="Remove">
