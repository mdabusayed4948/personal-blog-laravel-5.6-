                                   ...
                                   @foreach($subscribers as $key => $subscriber)
                                       <tr>
                                           ...
                                           <td class="text-center">
                                               ...
                                               <button class="btn btn-danger waves-effect waves-float" type="button" onclick="deleteSubscriber({{ $subscriber->id }})" data-toggle="tooltip" data-placement="top" title="Remove">
